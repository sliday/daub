...
[![Version](https://img.shields.io/badge/version-3.19.3-3D3832.svg)](https://daub.dev)
...
**Latest: v3.19.3** — Fix Text component swap detection in playground and MCP renderers. AI-generated specs with swapped `content`/`tag` props now render correctly across all three renderers.
