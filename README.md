...
[![Version](https://img.shields.io/badge/version-3.3.3-3D3832.svg)](https://daub.dev)
...
**Latest: v3.3.3** — Map-reduce code generation: Kimi plans architecture into chunks, parallel Gemini agents implement pieces, Kimi reviews the assembly. 2x faster for complex interactive UIs. 76 components, 20 theme families.
