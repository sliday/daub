...
[![Version](https://img.shields.io/badge/version-3.3.1-3D3832.svg)](https://daub.dev)
...
**Latest: v3.3.1** — Two-LLM interactivity pipeline (Gemini analyze + Kimi code gen) for fully functional games, quizzes, and interactive apps. 76 components, 20 theme families.
