...
[![Version](https://img.shields.io/badge/version-2.8.5-3D3832.svg)](https://daub.dev)
...
**Latest: v2.8.5** — Progressive streaming render: preview now updates live during AI generation. Card body spacing fix, Surface border-radius fix. 76 components, 20 theme families.
