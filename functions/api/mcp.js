...
const BLOCK_INDEX = [
  ...
  {"id":"forgot-password-01","category":"auth","file":"auth/forgot-password-01.json","description":"Forgot Password block for auth","tags":["auth","forgot","password"],"element_count":11,"components_used":["Stack","Card","Alert","Field","Input","Button","Separator","Text"]},
  {"id":"login-form-01","category":"auth","file":"auth/login-form-01.json","description":"Login Form block for auth","tags":["auth","login","form"],"element_count":15,"components_used":["Stack","Card","Field","Input","Checkbox","Button","Separator","Text"]},
  {"id":"register-form-01","category":"auth","file":"auth/register-form-01.json","description":"Register Form block for auth","tags":["auth","register","form"],"element_count":20,"components_used":["Stack","Card","Grid","Field","Input","Checkbox","Button","Separator","Text"]},
  {"id":"reset-password-01","category":"auth","file":"auth/reset-password-01.json","description":"Reset Password block for auth","tags":["auth","reset","password"],"element_count":15,"components_used":["Stack","Card","Field","Input","Progress","Text","Button","Separator"]},
  {"id":"social-login-01","category":"auth","file":"auth/social-login-01.json","description":"Social Login block for auth","tags":["auth","social","login"],"element_count":18,"components_used":["Stack","Card","Button","Separator","Text","Field","Input"]},
  ...
  {"id":"blog-newsletter-01","category":"blog","file":"blog/blog-newsletter-01.json","description":"Blog Newsletter block for blog","tags":["blog","blog","newsletter"],"element_count":26,"components_used":["Stack","Text","Grid","Card","Image","Surface","InputGroup","Input","Button"]},
  ...
  {"id":"contact-form-simple-01","category":"contact","file":"contact/contact-form-simple-01.json","description":"Contact Form Simple block for contact","tags":["contact","contact","form","simple"],"element_count":18,"components_used":["Stack","Text","Surface","Grid","Field","Input","Textarea","Button"]},
  ...
  {"id":"cta-split-01","category":"cta","file":"cta/cta-split-01.json","description":"Cta Split block for cta","tags":["cta","cta","split"],"element_count":21,"components_used":["Stack","Badge","Text","Surface","Field","Input","Button"]},
  {"id":"cta-with-form-01","category":"cta","file":"cta/cta-with-form-01.json","description":"Cta With Form block for cta","tags":["cta","cta","with","form"],"element_count":15,"components_used":["Stack","Text","Field","Input","Button","AvatarGroup","Avatar"]},
  ...
  {"id":"stats-row-01","category":"stats","file":"stats/stats-row-01.json","description":"4-column KPI stat cards row (Revenue, Users, Conversion, Avg Order) with trends","tags":["dashboard","stats","kpi","metrics"],"element_count":16,"components_used":["Stack","Text","Separator"]},
  ...
  {"id":"checkout-form-01","category":"ecommerce","file":"ecommerce/checkout-form-01.json","description":"Checkout Form block for ecommerce","tags":["ecommerce","checkout","form"],"element_count":44,"components_used":["Stack","Text","Stepper","Field","Input","Select","Separator","Checkbox","Surface","List","Button"]},
  ...
  {"id":"coming-soon-01","category":"error-pages","file":"error-pages/coming-soon-01.json","description":"Coming Soon block for error-pages","tags":["error-pages","coming","soon"],"element_count":27,"components_used":["Stack","Badge","Text","Progress","Chip","Surface","Input","Button","Grid","Card"]},
  {"id":"maintenance-page-01","category":"error-pages","file":"error-pages/maintenance-page-01.json","description":"Maintenance Page block for error-pages","tags":["error-pages","maintenance","page"],"element_count":26,"components_used":["Stack","Image","Text","Separator","Progress","Input","Button"]},
  ...
  {"id":"hero-with-form-01","category":"hero","file":"hero/hero-with-form-01.json","description":"Hero With Form block for hero","tags":["hero","hero","with","form"],"element_count":13,"components_used":["Grid","Stack","Text","List","Card","Field","Input","Select","Button"]},
  ...
  {"id":"tab-nav-01","category":"navigation","file":"navigation/tab-nav-01.json","description":"Tab Nav block for navigation","tags":["navigation","tab","nav"],"element_count":18,"components_used":["Stack","Text","Button","Tabs","Field","Input","Select","Switch"]},
  ...
  {"id":"newsletter-card-01","category":"newsletter","file":"newsletter/newsletter-card-01.json","description":"Newsletter Card block for newsletter","tags":["newsletter","newsletter","card"],"element_count":12,"components_used":["Card","Stack","Badge","Field","Input","Button","Text"]},
  {"id":"newsletter-footer-01","category":"newsletter","file":"newsletter/newsletter-footer-01.json","description":"Newsletter Footer block for newsletter","tags":["newsletter","newsletter","footer"],"element_count":15,"components_used":["Surface","Stack","Text","Button","InputGroup","Input"]},
  {"id":"newsletter-inline-01","category":"newsletter","file":"newsletter/newsletter-inline-01.json","description":"Newsletter Inline block for newsletter","tags":["newsletter","newsletter","inline"],"element_count":7,"components_used":["Stack","Text","InputGroup","Input","Button"]},
  {"id":"newsletter-popup-01","category":"newsletter","file":"newsletter/newsletter-popup-01.json","description":"Newsletter Popup block for newsletter","tags":["newsletter","newsletter","popup"],"element_count":10,"components_used":["Modal","Stack","Text","Input","Button"]},
  ...
  {"id":"login-split-quote-01","category":"auth","file":"auth/login-split-quote-01.json","description":"Login page variant using Grid layout with 31 elements","tags":["auth","login","form"],"element_count":31,"components_used":["Avatar","Button","Checkbox","Field","Grid","Icon","Input","Stack","Surface","Text"]},
  {"id":"login-page-card-01","category":"auth","file":"auth/login-page-card-01.json","description":"Login page variant using Stack layout with 20 elements","tags":["auth","login","form"],"element_count":20,"components_used":["Button","Card","Checkbox","Field","Icon","Input","Separator","Stack","Text"]},
  {"id":"login-page-card-02","category":"auth","file":"auth/login-page-card-02.json","description":"Login page variant using Stack layout with 18 elements","tags":["auth","login","form"],"element_count":18,"components_used":["Button","Card","Checkbox","Icon","Input","Stack","Text"]},
  {"id":"login-page-illustration-01","category":"auth","file":"auth/login-page-illustration-01.json","description":"Login page variant using Stack layout with 19 elements","tags":["auth","login","form"],"element_count":19,"components_used":["Button","Checkbox","Field","Image","Input","Stack","Text"]},
  {"id":"login-page-minimal-01","category":"auth","file":"auth/login-page-minimal-01.json","description":"Login page variant using Stack layout with 18 elements","tags":["auth","login","form"],"element_count":18,"components_used":["Button","Icon","Input","Stack","Text"]},
  {"id":"login-page-nav-01","category":"auth","file":"auth/login-page-nav-01.json","description":"Login page variant using Stack layout with 23 elements","tags":["auth","login","form"],"element_count":23,"components_used":["Button","Checkbox","Field","Icon","Input","Stack","Text"]},
  {"id":"login-page-simple-01","category":"auth","file":"auth/login-page-simple-01.json","description":"Login page variant using Stack layout with 19 elements","tags":["auth","login","form"],"element_count":19,"components_used":["Button","Checkbox","Field","Icon","Input","Stack","Text"]},
  {"id":"login-page-social-01","category":"auth","file":"auth/login-page-social-01.json","description":"Login page variant using Stack layout with 17 elements","tags":["auth","login","form"],"element_count":17,"components_used":["Button","Icon","Input","Separator","Stack","Surface","Text"]},
  {"id":"login-page-social-leading-01","category":"auth","file":"auth/login-page-social-leading-01.json","description":"Login page variant using Stack layout with 12 elements","tags":["auth","login","form"],"element_count":12,"components_used":["Button","Icon","Input","Separator","Stack","Surface","Text"]},
  {"id":"login-split-carousel-01","category":"auth","file":"auth/login-split-carousel-01.json","description":"Login page variant using Grid layout with 43 elements","tags":["auth","login","form"],"element_count":43,"components_used":["Badge","Button","Checkbox","Field","Grid","Icon","Image","Input","Stack","Surface","Text"]},
  {"id":"login-split-geometric-01","category":"auth","file":"auth/login-split-geometric-01.json","description":"Login page variant using Grid layout with 28 elements","tags":["auth","login","form"],"element_count":28,"components_used":["Button","Checkbox","Field","Grid","Icon","Image","Input","Stack","Surface","Text"]},
  {"id":"login-split-image-01","category":"auth","file":"auth/login-split-image-01.json","description":"Login page variant using Grid layout with 22 elements","tags":["auth","login","form"],"element_count":22,"components_used":["Button","Checkbox","Field","Grid","Image","Input","Stack","Text"]},
  {"id":"login-split-image-quote-01","category":"auth","file":"auth/login-split-image-quote-01.json","description":"Login page variant using Grid layout with 31 elements","tags":["auth","login","form"],"element_count":31,"components_used":["Button","Checkbox","Field","Grid","Icon","Input","Stack","Surface","Text"]},
  {"id":"login-split-mockup-01","category":"auth","file":"auth/login-split-mockup-01.json","description":"Login page variant using Grid layout with 24 elements","tags":["auth","login","form"],"element_count":24,"components_used":["Button","Checkbox","Field","Grid","Image","Input","Stack","Surface","Text"]},
  {"id":"login-split-mockup-quote-01","category":"auth","file":"auth/login-split-mockup-quote-01.json","description":"Login page variant using Grid layout with 31 elements","tags":["auth","login","form"],"element_count":31,"components_used":["Avatar","Button","Checkbox","Field","Grid","Image","Input","Stack","Surface","Text"]},
  {"id":"forgot-password-check-email-01","category":"auth","file":"auth/forgot-password-check-email-01.json","description":"Forgot Password Check Email screen with 12 elements","tags":["auth","forgot-password","form"],"element_count":12,"components_used":["Button","Icon","Stack","Text"]},
  {"id":"forgot-password-form-01","category":"auth","file":"auth/forgot-password-form-01.json","description":"Forgot Password Form screen with 11 elements","tags":["auth","forgot-password","form"],"element_count":11,"components_used":["Button","Field","Icon","Input","Stack","Text"]},
  {"id":"forgot-password-new-password-01","category":"auth","file":"auth/forgot-password-new-password-01.json","description":"Forgot Password New Password screen with 14 elements","tags":["auth","forgot-password","form"],"element_count":14,"components_used":["Button","Field","Icon","Input","Stack","Text"]},
  {"id":"forgot-password-success-01","category":"auth","file":"auth/forgot-password-success-01.json","description":"Forgot Password Success screen with 9 elements","tags":["auth","forgot-password","form"],"element_count":9,"components_used":["Button","Icon","Stack","Text"]},
  {"id":"signup-card-01","category":"auth","file":"auth/signup-card-01.json","description":"Signup Card screen with 21 elements","tags":["auth","signup"],"element_count":21,"components_used":["Button","Card","Field","Icon","Input","Stack","Surface","Text"]},
  {"id":"signup-card-02","category":"auth","file":"auth/signup-card-02.json","description":"Signup Card screen with 25 elements","tags":["auth","signup"],"element_count":25,"components_used":["Button","Card","Field","Icon","Input","Stack","Surface","Text"]},
  {"id":"signup-nav-01","category":"auth","file":"auth/signup-nav-01.json","description":"Signup Nav screen with 28 elements","tags":["auth","signup"],"element_count":28,"components_used":["Button","Field","Icon","Input","Stack","Text"]},
  {"id":"signup-progress-01","category":"auth","file":"auth/signup-progress-01.json","description":"Signup Progress screen with 20 elements","tags":["auth","signup"],"element_count":20,"components_used":["Button","Field","Icon","Input","Separator","Stack","Text"]},
  {"id":"signup-progress-02","category":"auth","file":"auth/signup-progress-02.json","description":"Signup Progress screen with 32 elements","tags":["auth","signup"],"element_count":32,"components_used":["Button","Field","Grid","Icon","Input","Stack","Surface","Text"]},
  {"id":"signup-progress-03","category":"auth","file":"auth/signup-progress-03.json","description":"Signup Progress screen with 25 elements","tags":["auth","signup"],"element_count":25,"components_used":["Button","Field","Grid","Icon","Input","Stack","Text"]},
  {"id":"signup-sidebar-progress-01","category":"auth","file":"auth/signup-sidebar-progress-01.json","description":"Signup Sidebar Progress screen with 48 elements","tags":["auth","signup"],"element_count":48,"components_used":["Avatar","Button","Field","Grid","Icon","Input","Separator","Stack","Text"]},
  {"id":"signup-sidebar-progress-02","category":"auth","file":"auth/signup-sidebar-progress-02.json","description":"Signup Sidebar Progress screen with 43 elements","tags":["auth","signup"],"element_count":43,"components_used":["Avatar","Button","Field","Grid","Icon","Input","Separator","Stack","Text"]},
  {"id":"signup-sidebar-progress-03","category":"auth","file":"auth/signup-sidebar-progress-03.json","description":"Signup Sidebar Progress screen with 43 elements","tags":["auth","signup"],"element_count":43,"components_used":["Avatar","Badge","Button","Field","Grid","Icon","Input","Separator","Stack","Text"]},
  {"id":"signup-simple-01","category":"auth","file":"auth/signup-simple-01.json","description":"Signup Simple screen with 19 elements","tags":["auth","signup"],"element_count":19,"components_used":["Button","Field","Icon","Input","Stack","Text"]},
  {"id":"signup-social-01","category":"auth","file":"auth/signup-social-01.json","description":"Signup Social screen with 19 elements","tags":["auth","signup"],"element_count":19,"components_used":["Button","Field","Icon","Input","Separator","Stack","Text"]},
  {"id":"signup-social-leading-01","category":"auth","file":"auth/signup-social-leading-01.json","description":"Signup Social Leading screen with 18 elements","tags":["auth","signup"],"element_count":18,"components_used":["Button","Field","Icon","Input","Separator","Stack","Text"]},
  {"id":"signup-split-app-mockup-01","category":"auth","file":"auth/signup-split-app-mockup-01.json","description":"Signup Split App Mockup screen with 26 elements","tags":["auth","signup"],"element_count":26,"components_used":["Button","Field","Grid","Icon","Image","Input","Stack","Surface","Text"]},
  {"id":"signup-split-arrow-01","category":"auth","file":"auth/signup-split-arrow-01.json","description":"Signup Split Arrow screen with 37 elements","tags":["auth","signup"],"element_count":37,"components_used":["Avatar","Button","Field","Grid","Icon","Input","Stack","Surface","Text"]},
  {"id":"signup-split-carousel-01","category":"auth","file":"auth/signup-split-carousel-01.json","description":"Signup Split Carousel screen with 40 elements","tags":["auth","signup"],"element_count":40,"components_used":["Badge","Button","Field","Grid","Icon","Image","Input","Stack","Surface","Text"]},
  {"id":"signup-split-gradient-01","category":"auth","file":"auth/signup-split-gradient-01.json","description":"Signup Split Gradient screen with 25 elements","tags":["auth","signup"],"element_count":25,"components_used":["Button","Field","Grid","Icon","Input","Stack","Surface","Text"]},
  {"id":"signup-split-image-bg-01","category":"auth","file":"auth/signup-split-image-bg-01.json","description":"Signup Split Image Bg screen with 37 elements","tags":["auth","signup"],"element_count":37,"components_used":["Avatar","Button","Field","Grid","Icon","Input","Stack","Surface","Text"]},
  {"id":"signup-split-mockup-01","category":"auth","file":"auth/signup-split-mockup-01.json","description":"Signup Split Mockup screen with 27 elements","tags":["auth","signup"],"element_count":27,"components_used":["Button","Field","Grid","Icon","Image","Input","Stack","Surface","Text"]},
  {"id":"signup-split-mockup-quote-01","category":"auth","file":"auth/signup-split-mockup-quote-01.json","description":"Signup Split Mockup Quote screen with 34 elements","tags":["auth","signup"],"element_count":34,"components_used":["Avatar","Button","Field","Grid","Icon","Image","Input","Stack","Surface","Text"]},
  {"id":"signup-split-quote-carousel-01","category":"auth","file":"auth/signup-split-quote-carousel-01.json","description":"Signup Split Quote Carousel screen with 40 elements","tags":["auth","signup"],"element_count":40,"components_used":["Avatar","Badge","Button","Field","Grid","Icon","Input","Stack","Surface","Text"]},
  {"id":"signup-split-quote-image-01","category":"auth","file":"auth/signup-split-quote-image-01.json","description":"Signup Split Quote Image screen with 29 elements","tags":["auth","signup"],"element_count":29,"components_used":["Avatar","Button","Field","Grid","Icon","Input","Stack","Surface","Text"]},
  {"id":"signup-split-quote-image-02","category":"auth","file":"auth/signup-split-quote-image-02.json","description":"Signup Split Quote Image screen with 34 elements","tags":["auth","signup"],"element_count":34,"components_used":["Avatar","Button","Card","Field","Grid","Icon","Input","Stack","Surface","Text"]},
];
