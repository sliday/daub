...
var Stack = forwardRef(
  ({ direction, gap, justify, align, wrap, container, className, ...props }, ref) => /* @__PURE__ */ jsx(
    "div",
    {
      ref,
      className: cn(
...
var Grid = forwardRef(
  ({ columns, gap, align, container, className, ...props }, ref) => /* @__PURE__ */ jsx(
    "div",
    {
      ref,
      className: cn(
...
var Avatar = forwardRef(
  ({ src, alt, initials, size, className, ...props }, ref) => /* @__PURE__ */ jsx(
    "div",
    {
      ref,
      className: cn("db-avatar", size && `db-avatar--${size}`, className),
      ...props,
      children: src ? /* @__PURE__ */ jsx("img", { src, alt: alt ?? "" }) : initials ? /* @__PURE__ */ jsx("span", { children: initials }) : null
    }
  )
);
Avatar.displayName = "Avatar";
var AvatarGroup = forwardRef(
  ({ max: _max, className, ...props }, ref) => /* @__PURE__ */ jsx(
    "div",
    {
      ref,
...
var Progress = forwardRef(
  ({ value = 0, indeterminate, className, ...props }, ref) => /* @__PURE__ */ jsx(
    "div",
    {
      ref,
      className: cn(
...
var Skeleton = forwardRef(
  ({ variant, lines = 1, className, ...props }, ref) => {
    ...
    if (lines > 1) {
      return /* @__PURE__ */ jsx("div", { ref, ...props, children: Array.from({ length: lines }, (_, i) => /* @__PURE__ */ jsx("div", { className: classes }, i)) });
    }
    return /* @__PURE__ */ jsx("div", { ref, className: classes, ...props });
  }
);
  ...
  ({ label, value, trend, trendValue, icon, horizontal, className, ...props }, ref) => /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        trend && /* @__PURE__ */ jsx("div", { className: cn("db-stat__trend", `db-stat__trend--${trend}`), children: trendValue })
      ]
    }
  )
);
...
var ChartCard = forwardRef(
  ({ title, className, children, ...props }, ref) => /* @__PURE__ */ jsxs(
    "div",
    {
      ref,
      ...
      ...props,
      children: [
        title && /* @__PURE__ */ jsx("div", { className: "db-chart-card__header", children: /* @__PURE__ */ jsx("h3", { children: title }) }),
        /* @__PURE__ */ jsx("div", { className: "db-chart-card__body", children })
      ]
    }
  )
);
...
var Chart = forwardRef(
  ({ bars, secondary, className, ...props }, ref) => /* @__PURE__ */ jsx(
    "div",
    {
      ref,
      ...props,
      ...
      children: bars.map((bar, i) => /* @__PURE__ */ jsx(
        "div",
        {
          className: "db-chart__bar",
          style: { height: `${bar.value}%` },
          children: bar.label && /* @__PURE__ */ jsx("span", { className: "db-chart__label", children: bar.label })
        },
        i
      ))
    }
...
var Button = forwardRef(
  ({ variant, size, loading, icon, className, disabled, children, ...props }, ref) => /* @__PURE__ */ jsx(
    "button",
    {
      ref,
      className: cn(
...
var ButtonGroup = forwardRef(
  ({ className, children, ...props }, ref) => /* @__PURE__ */ jsx("div", { ref, className: cn("db-btn-group", className), ...props, children })
);
  ...
  ({ label, helper, error, className, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        ...props,
        children: [
          label && /* @__PURE__ */ jsx("label", { className: "db-label", children: label }),
          children,
          helperText && /* @__PURE__ */ jsx("span", { className: "db-field__helper", children: helperText })
        ]
      }
    );
  }
...
var Select = forwardRef(
  ({ label, options, className, ...props }, ref) => /* @__PURE__ */ jsxs("div", { className: cn("db-select", className), children: [
    label && /* @__PURE__ */ jsx("label", { className: "db-label", children: label }),
    /* @__PURE__ */ jsx("select", { ref, className: "db-select__native", ...props, children: options?.map((opt) => /* @__PURE__ */ jsx("option", { value: opt.value, children: opt.label }, opt.value)) })
  ] })
);
...
var Kbd = forwardRef(
  ({ keys, className, children, ...props }, ref) => {
    if (keys && keys.length > 0) {
      return /* @__PURE__ */ jsx("span", { ref, className, children: keys.map((key, i) => /* @__PURE__ */ jsxs("span", { children: [
        i > 0 && " + ",
...
var List = forwardRef(
  ({ items, className, children, ...props }, ref) => /* @__PURE__ */ jsxs("div", { ref, className: cn("db-list", className), ...props, children: [
    items?.map((item, i) => /* @__PURE__ */ jsxs("div", { className: "db-list__item", children: [
...
var Table = forwardRef(
  ({ columns, rows, sortable, className, ...props }, ref) => /* @__PURE__ */ jsx("div", { className: cn("db-table", sortable && "db-table--sortable", className), ...props, children: /* @__PURE__ */ jsxs("table", { ref, children: [
    /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsx("tr", { children: columns.map((col, i) => /* @__PURE__ */ jsx("th", { children: col }, i)) }) }),
...
var DataTable = forwardRef(
  ({ columns, rows, selectable, className, ...props }, ref) => /* @__PURE__ */ jsx("div", { className: cn("db-data-table", className), ...props, children: /* @__PURE__ */ jsxs("table", { ref, children: [
    /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
      selectable && /* @__PURE__ */ jsx("th", { children: /* @__PURE__ */ jsx("input", { type: "checkbox" }) }),
      columns.map((col, i) => /* @__PURE__ */ jsx("th", { "data-sortable": col.sortable || void 0, children: col.label }, i))
    ] }) }),
    /* @__PURE__ */ jsx("tbody", { children: rows.map((row, i) => /* @__PURE__ */ jsxs("tr", { children: [
      selectable && /* @__PURE__ */ jsx("td", { children: /* @__PURE__ */ jsx("input", { type: "checkbox" }) }),
...
var Chip = forwardRef(
  ({ color, active, closable, onClose, className, children, ...props }, ref) => /* @__PURE__ */ jsxs(
    "span",
    {
      ref,
      className: cn(
      ...
      children: [
        children,
        closable && /* @__PURE__ */ jsx("button", { className: "db-chip__close", onClick: onClose, type: "button", children: "\xD7" })
      ]
    }
  )
);
...
var Breadcrumbs = forwardRef(
  ({ items, className, ...props }, ref) => /* @__PURE__ */ jsx(
    "nav",
    {
      ...
      children: /* @__PURE__ */ jsx("ol", { children: items.map((item, i) => {
        const isLast = i === items.length - 1;
        return /* @__PURE__ */ jsx("li", { children: isLast ? /* @__PURE__ */ jsx("span", { "aria-current": "page", children: item.label }) : /* @__PURE__ */ jsx("a", { href: item.href, children: item.label }) }, i);
      }) })
    }
  )
);
    ...
    return /* @__PURE__ */ jsxs(
      "nav",
      {
        ...
        children: [
          ...
          pages.map(
            (page, i) => page === "ellipsis" ? /* @__PURE__ */ jsx("span", { className: "db-pagination__ellipsis", children: "\u2026" }, `e${i}`) : /* @__PURE__ */ jsx(
              "button",
              {
                className: cn(
                  "db-pagination__page",
...
var NavMenu = forwardRef(
  ({ items, className, ...props }, ref) => /* @__PURE__ */ jsx("nav", { ref, ...props, className: cn("db-nav-menu", className), children: items.map((item, i) => /* @__PURE__ */ jsx(
    "a",
    {
      href: item.href,
      className: cn(
...
var BottomNav = forwardRef(
  ({ items, className, ...props }, ref) => /* @__PURE__ */ jsx("nav", { ref, ...props, className: cn("db-bottom-nav", className), children: items.map((item, i) => /* @__PURE__ */ jsxs(
    "a",
    {
      href: item.href,
      className: cn(
...
var Stepper = forwardRef(
  ({ steps, vertical, className, ...props }, ref) => /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: steps.map((step, i) => /* @__PURE__ */ jsxs(
        "div",
        {
          className: cn(
            "db-stepper__step",
          ...
          children: [
            /* @__PURE__ */ jsx("div", { className: "db-stepper__circle", children: step.completed ? "\u2713" : i + 1 }),
...
var Navbar = forwardRef(
  ({ brand, brandHref, children, className, ...props }, ref) => /* @__PURE__ */ jsxs("nav", { ref, ...props, className: cn("db-navbar", className), children: [
    brand && /* @__PURE__ */ jsx("a", { className: "db-navbar__brand", href: brandHref, children: brand }),
    /* @__PURE__ */ jsx("div", { className: "db-navbar__nav", children })
  ] })
);
Navbar.displayName = "Navbar";
var HoverCard = forwardRef(
  ({ trigger, content, className, children, ...props }, ref) => /* @__PURE__ */ jsxs("div", { ref, ...props, className: cn("db-hover-card", className), children: [
    /* @__PURE__ */ jsx("div", { className: "db-hover-card__trigger", children: trigger }),
    /* @__PURE__ */ jsx("div", { className: "db-hover-card__content", children: content })
  ] })
);
HoverCard.displayName = "HoverCard";
function ThemeProvider({ theme, children }) {
  return /* @__PURE__ */ jsx("div", { "data-theme": theme, children });
}
...
var Tabs = forwardRef(
  ({ tabs, activeTab, defaultActiveTab = 0, onChange, className, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { ref, className: cn("db-tabs", className), ...props, children: [
      /* @__PURE__ */ jsx("div", { className: "db-tabs__list", role: "tablist", children: tabs.map((t, i) => /* @__PURE__ */ jsx(
        "button",
        {
      ...
      /* @__PURE__ */ jsx("div", { className: "db-tabs__panel", role: "tabpanel", children: tabs[current]?.content })
    ] });
  }
);
...
var Accordion = forwardRef(
  ({ items, multi = false, openItems, defaultOpenItems = [], onChange, className, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, className: cn("db-accordion", className), ...props, children: items.map((item, i) => {
      ...
      return /* @__PURE__ */ jsxs("div", { className: cn("db-accordion__item", isOpen && "db-accordion__item--open"), children: [
        /* @__PURE__ */ jsxs(
          "button",
          {
            ...
            children: [
              item.trigger,
              /* @__PURE__ */ jsx("span", { className: "db-accordion__icon", children: "\u25B8" })
            ]
          }
        ),
        isOpen && /* @__PURE__ */ jsx("div", { className: "db-accordion__content", children: item.content })
      ] }, i);
    }) });
  }
);
...
var Collapsible = forwardRef(
  ({ open, defaultOpen = false, onChange, trigger, className, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { ref, className: cn("db-collapsible", isOpen && "db-collapsible--open", className), ...props, children: [
      /* @__PURE__ */ jsx(
        "button",
        {
      ...
      isOpen && /* @__PURE__ */ jsx("div", { className: "db-collapsible__content", children })
    ] });
  }
);
...
var CustomSelect = forwardRef(
  ({ value, defaultValue = "", onChange, options, placeholder = "Select...", searchable = false, className, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { ref: setRefs, className: cn("db-custom-select", isOpen && "db-custom-select--open", className), ...props, children: [
      /* @__PURE__ */ jsx(
        "button",
        {
...
var Calendar = forwardRef(
  ({ selected, defaultSelected = "", onChange, month: initialMonth, className, ...props }, ref) => {
    ...
    const [displayed, setDisplayed] = useState(() => initialMonth ?? (value ? /* @__PURE__ */ new Date(value + "T00:00") : /* @__PURE__ */ new Date()));
    ...
    return /* @__PURE__ */ jsxs("div", { ref, className: cn("db-calendar", className), ...props, children: [
      /* @__PURE__ */ jsxs("div", { className: "db-calendar__header", children: [
        /* @__PURE__ */ jsx("button", { className: "db-calendar__nav", onClick: prevMonth, type: "button", children: "\u2039" }),
        /* @__PURE__ */ jsxs("span", { className: "db-calendar__title", children: [
          monthName,
          " ",
          year
        ] }),
        /* @__PURE__ */ jsx("button", { className: "db-calendar__nav", onClick: nextMonth, type: "button", children: "\u203A" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "db-calendar__grid", children: [
        DAY_NAMES.map((d) => /* @__PURE__ */ jsx("span", { className: "db-calendar__day-name", children: d }, d)),
        days.map((d, i) => {
...
var DatePicker = forwardRef(
  ({ value, defaultValue = "", onChange, label, placeholder = "Select date", className, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { ref: setRefs, className: cn("db-date-picker", className), ...props, children: [
      label && /* @__PURE__ */ jsx("label", { className: "db-label", children: label }),
      /* @__PURE__ */ jsx(
        "input",
        {
      ...
      isOpen && /* @__PURE__ */ jsx("div", { className: "db-date-picker__dropdown", children: /* @__PURE__ */ jsx(
        Calendar,
        {
          selected: val,
          onChange: (date) => {
...
var Carousel = forwardRef(
  ({ current, defaultCurrent = 0, onChange, autoplay = false, duration = 5e3, className, children, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { ref, className: cn("db-carousel", className), ...props, children: [
      /* @__PURE__ */ jsx("div", { className: "db-carousel__track", style: { transform: `translateX(-${idx * 100}%)` }, children: slides.map((child, i) => /* @__PURE__ */ jsx("div", { className: "db-carousel__slide", children: child }, i)) }),
      /* @__PURE__ */ jsx("button", { className: "db-carousel__prev", onClick: prev, type: "button", children: "\u2039" }),
      /* @__PURE__ */ jsx("button", { className: "db-carousel__next", onClick: next, type: "button", children: "\u203A" }),
      /* @__PURE__ */ jsx("div", { className: "db-carousel__dots", children: slides.map((_, i) => /* @__PURE__ */ jsx(
        "button",
        {
...
var Checkbox = forwardRef(
  ({ checked, defaultChecked, onChange, label, className, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("label", { className: cn("db-checkbox", className), children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          ref,
      ...
      /* @__PURE__ */ jsx("span", { className: "db-checkbox__box" }),
...
var Radio = forwardRef(
  ({ checked, defaultChecked, onChange, label, name, value, className, ...props }, ref) => {
    const [on, setOn] = useControllable(checked, defaultChecked ?? false, onChange);
    return /* @__PURE__ */ jsxs("label", { className: cn("db-radio", className), children: [
      /* @__PURE__ */ jsx(
        "input",
        {
          ref,
...
var RadioGroup = forwardRef(
  ({ value, defaultValue, onChange, name, options = [], className, ...props }, ref) => {
    const [selected, setSelected] = useControllable(value, defaultValue ?? "", onChange);
    return /* @__PURE__ */ jsx("div", { ref, className: cn("db-radio-group", className), role: "radiogroup", ...props, children: options.map((opt) => /* @__PURE__ */ jsx(
      Radio,
      {
        name,
        value: opt.value,
...
var Slider = forwardRef(
  ({ value, defaultValue, onChange, min = 0, max = 100, step = 1, label, className, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsxs("div", { className: cn("db-slider", className), ...props, children: [
      label && /* @__PURE__ */ jsxs("label", { className: "db-slider__label", children: [
        label,
        /* @__PURE__ */ jsx("span", { className: "db-slider__value", children: val })
      ] }),
      /* @__PURE__ */ jsx(
        "input",
        {
...
var ToggleGroup = forwardRef(
  ({ value, defaultValue, onChange, multiple, className, children, ...props }, ref) => /* @__PURE__ */ jsx(
    "div",
    {
      ref,
...
var InputOTP = forwardRef(
  ({ length = 6, value, defaultValue, onChange, separator, className, ...props }, ref) => {
    ...
    return /* @__PURE__ */ jsx("div", { ref, className: cn("db-otp", className), ...props, children: slots });
  }
);
